...
parser.add_argument('--noise_mode', default='rand1')
...
def train(epoch, net, net2, optimizer, labeled_trainloader, unlabeled_trainloader):
    ...
    while(count_iters < max_iters):
        print(f'{count_iters}/{max_iters} iter during co-divide\n')
        ## Loss statistics
        loss_x = 0
        loss_u = 0
        loss_scl = 0
        ...
        for batch_idx, (inputs_x, inputs_x2, inputs_x3, inputs_x4, labels_x, w_x) in enumerate(labeled_trainloader):
            ...
            sys.stdout.write('\r')
            sys.stdout.write(
                '%s:%.1f-%s | Epoch [%3d/%3d] Iter[%3d/%3d]\t cont_iter[%d] Labeled loss: %.2f  Unlabeled loss: %.2f Contrastive Loss:%.4f'
                % (args.dataset, args.r, args.noise_mode, epoch, args.num_epochs, batch_idx + 1, num_iter, count_iters,
...
if __name__ == '__main__':
    ...
    # warm_criterion = robust_loss.SCELoss(args.dataset, args.num_class, '0')
    ...
    # eval_loader.dataset.noise_prior_print()
