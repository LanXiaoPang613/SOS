...
def test(epoch,net1,net2):
    ...
    test_log.write('Epoch:%d   Accuracy:%.2f, precision:%.2f, recall:%.2f, f1:%.2f \n' % (
    epoch, acc, precision, recall, f1))
    test_log.flush()
...
if __name__ == '__main__':
    ...
    if args.resume:
        start_epoch = torch.load(os.path.join(model_save_loc, model_name_1))['epoch']
        ...
        acc = test(start_epoch, net1, net2)
    else:
        start_epoch = 0
